...
public class VerifyPhoneNumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String strPhone = edt.getText().toString().trim();
                ...
                PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                Toast.makeText(VerifyPhoneNumberActivity.this, "The verification Failed",
                            ...
                            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                goToEnterOtpActivity(strPhone, s);
                            }
    ...
    private void goToEnterOtpActivity(String strPhone, String s) {
    ...
    private void setTitleToolbar(){
        if (getSupportActionBar() != null){
            getSupportActionBar().setTitle("VerifyPhoneNumber Activity");
        }
    }
}